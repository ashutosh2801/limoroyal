...
import AboutBanner from '../src/assets/banners/about-banner.jpg'
import AboutBanner2 from '../src/assets/banners/about-banner2.jpg'
        ...
        <div className='bg-[#0a0a0a] py-15 pr-5 lg:pr-62 pl-5 lg:pl-0'>
          <div className='flex flex-col lg:flex-row lg:space-x-12 space-y-10 lg:space-y-0 items-center'>
            ...
            <div className='w-full lg:w-2/5' data-aos="fade-up">
              ...
              <a href='/online-reservations' className='inline-block book-now-slide text-sm px-10 py-5 mt-10 uppercase'>Book Now</a>
            </div>
          </div>          
        </div>
      </div>

...
import AreasBanner1 from '../src/assets/areas-served/1.jpg'
import AreasBanner2 from '../src/assets/areas-served/2.jpg'
import AreasBanner3 from '../src/assets/areas-served/3.jpg'
import AreasBanner4 from '../src/assets/areas-served/4.jpg'
import AreasBanner5 from '../src/assets/areas-served/5.jpg'
    ...
    <div>
        ...
        <div>
            <div className='bg-[#0a0a0a]'>
                            ...
                            >
                                {testimonials.map((item, index) => (
                                    <SwiperSlide key={index}>
                                        <div className='bg-black p-8 md:p-15 lg:min-h-[300px] flex flex-col justify-center'>
                                            <div>
                ...
                <div className='pt-5 md:pt-10 lg:pt-20 pb-15'>
                    <div className='container mx-auto px-2'>
                        ...
                        <div data-aos="fade-up">
                            <a href='/online-reservations' className='inline-block view-more-btn text-sm px-9 py-4 mt-10 mr-3 uppercase'>Book Now</a>
                            <a href='https://maps.app.goo.gl/YKPLgaV9XEWUdKay7' target='_blank' className='inline-block check-map-btn text-sm px-9 py-4 mt-10 uppercase'>Check Map</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className='bg-black'>
                ...
                <div className='pt-5 md:pt-10 lg:pt-20 pb-15'>
                    <div className='container mx-auto px-2'>
                        ...
                        <div data-aos="fade-up">
                            <a href='/online-reservations' className='inline-block view-more-btn text-sm px-9 py-4 mt-10 mr-3 uppercase'>Book Now</a>
                            <a href='https://maps.app.goo.gl/1jA6Tca3RLnhTLPv8' target='_blank' className='inline-block check-map-btn text-sm px-9 py-4 mt-10 uppercase'>Check Map</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className='bg-black'>
                ...
                <div className='pt-5 md:pt-10 lg:pt-20 pb-15'>
                    <div className='container mx-auto px-2'>
                        ...
                        <div data-aos="fade-up">
                            <a href='/online-reservations' className='inline-block view-more-btn text-sm px-9 py-4 mt-10 mr-3 uppercase'>Book Now</a>
                            <a href='https://maps.app.goo.gl/fspJwJ1iHHB15DKx7' target='_blank' className='inline-block check-map-btn text-sm px-9 py-4 mt-10 uppercase'>Check Map</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className='bg-[#0a0a0a]'>
                ...
                <div className='pt-5 md:pt-10 lg:pt-20 pb-15'>
                    <div className='container mx-auto px-2'>
                        ...
                        <div data-aos="fade-up">
                            <a href='/online-reservations' className='inline-block view-more-btn text-sm px-9 py-4 mt-10 mr-3 uppercase'>Book Now</a>
                            <a href='https://maps.app.goo.gl/db2ZdGosJdCCHgiT8' target='_blank' className='inline-block check-map-btn text-sm px-9 py-4 mt-10 uppercase'>Check Map</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className='bg-black'>
                ...
                <div className='pt-5 md:pt-10 lg:pt-20 pb-15'>
                    <div className='container mx-auto px-2'>
                        ...
                        <div data-aos="fade-up">
                            <a href='/online-reservations' className='inline-block view-more-btn text-sm px-9 py-4 mt-10 mr-3 uppercase'>Book Now</a>
                            <a href='https://maps.app.goo.gl/dKy6mEvuDeAB34mx5' target='_blank' className='inline-block check-map-btn text-sm px-9 py-4 mt-10 uppercase'>Check Map</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className='bg-[#0a0a0a]'>
                ...
                <div className='pt-5 md:pt-10 lg:pt-20 pb-15'>
                    <div className='container mx-auto px-2'>
                        ...
                        <div data-aos="fade-up">
                            <h5 className='text-white text-2xl lg:text-2xl mt-8'>With Limo Royale, you’ll enjoy the perfect blend of luxury and adventure in Sault Ste. Marie.</h5>
                            <a href='/online-reservations' className='inline-block view-more-btn text-sm px-9 py-4 mt-10 mr-3 uppercase'>Book Now</a>
                            <a href='https://maps.app.goo.gl/s4xJyRBUi3Y955YQ7' target='_blank' className='inline-block check-map-btn text-sm px-9 py-4 mt-10 uppercase'>Check Map</a>
                        </div>
                    </div>
                </div>
            </div>
